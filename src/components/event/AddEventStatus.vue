    ...
    <div class="field">
      ...
      <div class="control">
        <input
          class="input"
          type="text"
          placeholder="Event Status Name"
          v-model="EventStatusName"
        />
      </div>
    </div>
    <div class="control">
      <button class="button is-success" @click="saveEventStatus">Add</button>
...
export default {
  ...
  methods: {
    ...
    async saveEventStatus() {
      try { 
        await axios.post("https://api-2np.herokuapp.com/api/EventStatus", {
