<template>
  <div>
    ...
    <div class="control">
      <button class="button is-success" @click="saveServiceStatus">Add</button>
...
export default {
  ...
  methods: {
    ...
    async saveServiceStatus() {
      try { 
        await axios.post("https://api-2np.herokuapp.com/api/ServiceStatus", {
